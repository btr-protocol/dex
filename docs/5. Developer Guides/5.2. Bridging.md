...
The BTR Bridge (`BridgeV1`) enables cross-chain transfers of:
...
**Contract**: `contracts/src/BridgeV1.sol`
**Interface**: `IBridgeV1`
...
**TypeScript SDK**:
```typescript
import { BridgeV1 } from '@btr/sdk';

const bridge = new BridgeV1(bridgeAddress, signer);
