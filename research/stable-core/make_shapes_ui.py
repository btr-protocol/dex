...
notes_density=(
 ...
 "(<span class='k'>A=1000</span> PCS-StableSwap, <span class='k'>A=1500</span> Ellipsis) spreads depth smoothly. The BTR spline "
 "instead lays capital <i>uniformly</i> across a tight band and then hard-walls (±~2.5 bps at <span class='k'>disp 1000</span>) — "
 "price literally can't run past the band. So per dollar it front-loads more depth into the first few bps than Curve, matching "
 "Infinity's concentration but at real size and with a safety wall. The dispersion knob widens the box on purpose for the riskier "
 "legs (2000 USD1, 3000 USDe/FDUSD).</p>"
