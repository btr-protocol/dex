...
contract MockOracle is IOracle {
    ...
    function setFeed(bytes32 id, uint64 priceB64, uint32 sigma, uint16 confidence, uint16 ttl) external {
    ...
    function getFeed(bytes32 id) external view returns (FeedData memory f) { f = feeds[id]; }
