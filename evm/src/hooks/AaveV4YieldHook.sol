...
/// @title AaveV4YieldHook — Aave V4 Spoke supply-only (official reserveId ABI).
/// @dev Experimental: no mainnet Spoke pin. Positions are share-ledger on Spoke (no aToken ERC20).
