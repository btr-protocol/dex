...
contract FluidDexPool {
    ...
    function getImaginaryReserves() public view returns (uint256 i0, uint256 i1) {
        return FluidDexMath.imaginaryReserves(centerPrice, upperPercent, lowerPercent, reserve0, reserve1);
    }
...
contract FluidDexFactory {
    ...
    event PoolCreated(address indexed token0, address indexed token1, address pool, uint256 fee, uint256 rangePct);
