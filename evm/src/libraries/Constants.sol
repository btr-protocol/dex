...
library Constants {
  ...
  uint32 internal constant STABLE_SIGMA_PBPS = 1_000; // 0.1% (PBPS 1e6 base; = @btr-shared ONE_PCT_PBPS/10)
  ...
  /// @notice haircutSuppressor value at/above which the coverage haircut fully disables (2·BPS).
  ///         Config caps STRICTLY below this so the deficit is always at least partially socialized.
  uint16 internal constant HAIRCUT_SUPPRESSOR_DISABLE = 20_000;
  ...
  uint16 internal constant FEED_PAUSED_BIT = 1;
