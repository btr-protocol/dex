...
///         sample floored at |Δmark|/mark; swap path reads mark + `sigma`.
...
interface IOracle {
  struct FeedData {
    ...
    uint32 sigma; // stored σ (PBPS): signed sample floored at |Δmark|/mark. PRICING INPUT.
    ...
    // replay guard + true data-age. 0 on legacy-only feeds. Slot bits [192:240).
  }
