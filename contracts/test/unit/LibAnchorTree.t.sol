...
contract LibAnchorTreeHarness {
    ...
    function _getPoolStorage() internal pure returns (IPoolV1.PoolStorage storage $) {
    ...
    function setBaseToken(address baseToken) external {
        IPoolV1.PoolStorage storage $ = _getPoolStorage();
        $.baseToken = baseToken;
    }
    ...
    function findRoutingPath(
        address tokenIn,
        address tokenOut
    ) external view returns (IPoolV1.RoutePath memory path) {
        IPoolV1.PoolStorage storage $ = _getPoolStorage();
    ...
    function getAsset(address asset) external view returns (IPoolV1.Asset memory) {
        IPoolV1.PoolStorage storage $ = _getPoolStorage();
        return $.assets[asset];
    }
...
contract LibAnchorTreeTest is BaseTestSetup {
    ...
    function test_findRoutingPath_same_asset_reverts() public {
        ...
        IPoolV1.RoutePath memory path = harness.findRoutingPath(CHILD_A, CHILD_A);
    ...
    function test_findRoutingPath_direct_parent_child() public {
        ...
        IPoolV1.RoutePath memory path = harness.findRoutingPath(LEAF_A1, CHILD_A);
    ...
    function test_findRoutingPath_direct_child_parent() public {
        ...
        IPoolV1.RoutePath memory path = harness.findRoutingPath(CHILD_A, ROOT);
    ...
    function test_findRoutingPath_common_parent_siblings() public {
        ...
        IPoolV1.RoutePath memory path = harness.findRoutingPath(LEAF_A1, LEAF_A2);
    ...
    function test_findRoutingPath_different_branches() public {
        ...
        IPoolV1.RoutePath memory path = harness.findRoutingPath(LEAF_A1, LEAF_B1);
    ...
    function test_findRoutingPath_leaf_to_root() public {
        ...
        IPoolV1.RoutePath memory path = harness.findRoutingPath(LEAF_A1, ROOT);
    ...
    function test_findRoutingPath_root_to_leaf() public {
        ...
        IPoolV1.RoutePath memory path = harness.findRoutingPath(ROOT, LEAF_B1);
    ...
    function test_findRoutingPath_asymmetric_depths() public {
        ...
        IPoolV1.RoutePath memory path = harness.findRoutingPath(CHILD_A, LEAF_B1);
    ...
    function test_findRoutingPath_symmetry() public {
        ...
        IPoolV1.RoutePath memory pathAB = harness.findRoutingPath(LEAF_A1, LEAF_B1);
        IPoolV1.RoutePath memory pathBA = harness.findRoutingPath(LEAF_B1, LEAF_A1);
    ...
    function test_deep_tree_routing() public {
        ...
        IPoolV1.RoutePath memory path = harness.findRoutingPath(nodes[4], ROOT);
    ...
    function test_wide_tree_routing() public {
        ...
        IPoolV1.RoutePath memory path = harness.findRoutingPath(children[0], children[4]);
    ...
    function test_routing_preserves_endpoints() public {
        ...
        for (uint256 i = 0; i < pairs.length; i++) {
            for (uint256 j = 0; j < pairs.length; j++) {
                if (i != j) {
                    IPoolV1.RoutePath memory path = harness.findRoutingPath(pairs[i], pairs[j]);
