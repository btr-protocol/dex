...
contract StorageSlotTest is Test {
    ...
    function test_pool_proxy_module_registration() public {
        ...
        uint256 baseSlot = uint256(C.CORE_STORAGE_LOC);
        uint256 modulesSlot = baseSlot + 14;
        bytes4 selector = IAdminV1.requestAddAsset.selector;
        ...
        // getModule is defined in IAdminV1 and should be at admin module
        ...
        bytes4 getModuleSelector = IAdminV1.getModule.selector;
        ...
        bytes memory callData = abi.encodeWithSelector(IAdminV1.getModule.selector, selector);
    ...
    function test_compute_selector_slot() public pure {
        ...
        bytes4 requestAddAssetSelector = IAdminV1.requestAddAsset.selector;
        console2.log("IAdminV1.requestAddAsset.selector:");
        console2.logBytes4(requestAddAssetSelector);

        // getModule selector
        bytes4 getModuleSelector = IAdminV1.getModule.selector;
        console2.log("IAdminV1.getModule.selector:");
        console2.logBytes4(getModuleSelector);
