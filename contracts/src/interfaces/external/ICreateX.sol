...
interface ICreateX {
    ...
    function deployCreate2AndInit(bytes calldata initCode, bytes calldata data, Values calldata values)
        external
        payable
    ...
    function deployCreate2AndInit(bytes32 salt, bytes calldata initCode, bytes calldata data, Values calldata values)
        external
        payable
        returns (address newContract);
    function deployCreate2Clone(bytes32 salt, address implementation, bytes calldata data)
        external
        payable
    ...
    function deployCreate3AndInit(bytes32 salt, bytes calldata initCode, bytes calldata data, Values calldata values)
        external
        payable
        returns (address newContract);
    function deployCreate3AndInit(bytes calldata initCode, bytes calldata data, Values calldata values)
        external
        payable
        returns (address newContract);
    ...
    function deployCreateAndInit(bytes calldata initCode, bytes calldata data, Values calldata values)
        external
        payable
        returns (address newContract);
